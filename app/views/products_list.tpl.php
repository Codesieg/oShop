...
<section class="products-grid">
    <div class="container-fluid">
        ...
        <div class="row">
            <!-- product-->
            <?php foreach ($viewData['list'] as $product) : ?>
                
            <div class="product col-xl-3 col-lg-4 col-sm-6">
                <div class="product-image">
                    <a href="<?= $viewData['urlPrefix'] . "catalog/product/" . $product->getId() ?>" class="product-hover-overlay-link">
                        <img src="<?= $viewData['urlPrefix'] . $product->getPicture()?>" alt="product" class="img-fluid">
                    </a>
                </div>
                <div class="product-action-buttons">
                    <a href="<?= $viewData['urlPrefix'] . "catalog/product/" . $product->getId() ?>" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
                    <a href="<?= $viewData['urlPrefix'] . "catalog/product/" . $product->getId() ?> " class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
                </div>
                <div class="py-2">
                    <p class="text-muted text-sm mb-1"><?= $product->getBrandId()?></p>

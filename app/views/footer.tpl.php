                ...
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php foreach ($viewData['footerBrands'] as $brand) : ?>
                            <li><a href="<?= $viewData['urlPrefix'] . $brand->getId(); ?>"><?= $brand->getName(); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                <div class=" col-lg-4">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left">
                    <p class="mb-md-0">© 2021 oShop. Tous droits réservés.</p>
                </div>
                <div class="col-md-6">
                    <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                        <li class="list-inline-item">
                            <img src="<?= $viewData['urlPrefix'] ?>assets/images/visa.svg" alt="..." class="payment-icon">
                        </li>
                        <li class="list-inline-item">
                            <img src="<?= $viewData['urlPrefix'] ?>assets/images/mastercard.svg" alt="..." class="payment-icon">
                        </li>
                        <li class="list-inline-item">
                            <img src="<?= $viewData['urlPrefix'] ?>assets/images/paypal.svg" alt="..." class="payment-icon">
                        </li>
                    </ul>
                </div>
            </div>
